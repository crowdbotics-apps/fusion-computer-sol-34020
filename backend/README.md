...
## Project Structure
    ...
    ├── fusion_computer_sol_34020  # Django project configurations
...
1. Clone this repo and `cd fusion_computer_sol_34020`
...
2. Clone this repo and `cd fusion_computer_sol_34020`
